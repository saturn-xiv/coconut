...
std::vector<std::string> coconut::minio::Client::list_buckets() {
...
std::vector<std::string> coconut::minio::Client::list_objects(
...
bool coconut::minio::Client::is_bucket_exists(const std::string& bucket) {
  ::minio::s3::Client client(this->_base_url, &this->_credential_provider);
...
std::map<std::string, std::string> coconut::minio::Client::get_bucket_tags(
    const std::string& bucket) {
  ::minio::s3::Client client(this->_base_url, &this->_credential_provider);
...
void coconut::minio::Client::create_bucket(
...
void coconut::minio::Client::remove_bucket(const std::string& bucket) {
  ::minio::s3::Client client(this->_base_url, &this->_credential_provider);
...
void coconut::minio::Client::remove_object(const std::string& bucket,
...
std::string coconut::minio::Client::get_object_url(const std::string& bucket,
                                                   const std::string& object) {
  return this->_endpoint + "/" + this->bucket(bucket) + "/" + object;
}
std::map<std::string, std::string> coconut::minio::Client::get_object_tags(
...
std::string coconut::minio::Client::get_presigned_object_url(
    const std::string& bucket, const std::string& object,
...
std::string coconut::minio::Client::put_object(
    const std::string& bucket, const std::filesystem::path& file,
    const std::map<std::string, std::string> tags) {
  ::minio::s3::Client client(this->_base_url, &this->_credential_provider);
  const std::string object = coconut::uuid() + file.extension().string();
