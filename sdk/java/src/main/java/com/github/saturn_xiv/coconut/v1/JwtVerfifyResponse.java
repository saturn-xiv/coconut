...
public class JwtVerfifyResponse implements org.apache.thrift.TBase<JwtVerfifyResponse, JwtVerfifyResponse._Fields>, java.io.Serializable, Cloneable, Comparable<JwtVerfifyResponse> {
  ...
  private static final org.apache.thrift.protocol.TField JWT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("jwt_id", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String jwt_id; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.JWT_ID, new org.apache.thrift.meta_data.FieldMetaData("jwt_id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public JwtVerfifyResponse(JwtVerfifyResponse other) {
    ...
    if (other.isSetJwt_id()) {
      this.jwt_id = other.jwt_id;
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getJwt_id() {
    return this.jwt_id;
  }

  public JwtVerfifyResponse setJwt_id(@org.apache.thrift.annotation.Nullable java.lang.String jwt_id) {
    this.jwt_id = jwt_id;
    return this;
  }

  public void unsetJwt_id() {
    this.jwt_id = null;
  }

  /** Returns true if field jwt_id is set (has been assigned a value) and false otherwise */
  public boolean isSetJwt_id() {
    return this.jwt_id != null;
  }

  public void setJwt_idIsSet(boolean value) {
    if (!value) {
      this.jwt_id = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case JWT_ID:
      if (value == null) {
        ...
        setJwt_id((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(JwtVerfifyResponse that) {
    ...
    boolean this_present_jwt_id = true && this.isSetJwt_id();
    boolean that_present_jwt_id = true && that.isSetJwt_id();
    if (this_present_jwt_id || that_present_jwt_id) {
      if (!(this_present_jwt_id && that_present_jwt_id))
        return false;
      if (!this.jwt_id.equals(that.jwt_id))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetJwt_id()) ? 131071 : 524287);
    if (isSetJwt_id())
      hashCode = hashCode * 8191 + jwt_id.hashCode();
  ...
  public int compareTo(JwtVerfifyResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetJwt_id(), other.isSetJwt_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJwt_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jwt_id, other.jwt_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class JwtVerfifyResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<JwtVerfifyResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, JwtVerfifyResponse struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // JWT_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.jwt_id = iprot.readString();
              struct.setJwt_idIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JwtVerfifyResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.jwt_id != null) {
        oprot.writeFieldBegin(JWT_ID_FIELD_DESC);
        oprot.writeString(struct.jwt_id);
        oprot.writeFieldEnd();
      }
